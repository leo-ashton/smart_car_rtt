...
typedef enum
{
    ...
    PWM1_MODULE0_CHB_E24, // PWM1 子模块0 通道B  引脚可选范围
    PWM1_MODULE0_CHA_D12 = 1 * 40 + 5 * 1,
    PWM1_MODULE0_CHA_E23, // PWM1 子模块0 通道A  引脚可选范围

    PWM1_MODULE1_CHB_D15 = 1 * 40 + 5 * 2,
    PWM1_MODULE1_CHB_E26, // PWM1 子模块1 通道B  引脚可选范围
    PWM1_MODULE1_CHA_D14 = 1 * 40 + 5 * 3,
    PWM1_MODULE1_CHA_E25, // PWM1 子模块1 通道A  引脚可选范围

    PWM1_MODULE2_CHB_D17 = 1 * 40 + 5 * 4,
    PWM1_MODULE2_CHB_E28, // PWM1 子模块2 通道B  引脚可选范围
    PWM1_MODULE2_CHA_D16 = 1 * 40 + 5 * 5,
    PWM1_MODULE2_CHA_E27, // PWM1 子模块2 通道A  引脚可选范围

    PWM1_MODULE3_CHB_B11 = 1 * 40 + 5 * 6,
    PWM1_MODULE3_CHB_C17,
    PWM1_MODULE3_CHB_D1,
    PWM1_MODULE3_CHB_D25,
    PWM1_MODULE3_CHB_E13, // PWM1 子模块3 通道B  引脚可选范围
    PWM1_MODULE3_CHA_B10 = 1 * 40 + 5 * 7,
    PWM1_MODULE3_CHA_C16,
    PWM1_MODULE3_CHA_D0,
    PWM1_MODULE3_CHA_D24,
    PWM1_MODULE3_CHA_E12, // PWM1 子模块3 通道A  引脚可选范围

    //-----------------------------------------------------------------------------
    PWM2_MODULE0_CHB_C7 = 2 * 40 + 5 * 0,
    PWM2_MODULE0_CHB_E7, // PWM2 子模块0 通道B  引脚可选范围
    PWM2_MODULE0_CHA_C6 = 2 * 40 + 5 * 1,
    PWM2_MODULE0_CHA_E6, // PWM2 子模块0 通道A  引脚可选范围

    PWM2_MODULE1_CHB_C9 = 2 * 40 + 5 * 2,
    PWM2_MODULE1_CHB_E9, // PWM2 子模块1 通道B  引脚可选范围
    PWM2_MODULE1_CHA_C8 = 2 * 40 + 5 * 3,
    PWM2_MODULE1_CHA_E8, // PWM2 子模块1 通道A  引脚可选范围

    PWM2_MODULE2_CHB_C11 = 2 * 40 + 5 * 4,
    PWM2_MODULE2_CHB_E11, // PWM2 子模块2 通道B  引脚可选范围
    PWM2_MODULE2_CHA_C10 = 2 * 40 + 5 * 5,
    PWM2_MODULE2_CHA_E10, // PWM2 子模块2 通道A  引脚可选范围

    PWM2_MODULE3_CHB_B1 = 2 * 40 + 5 * 6,
    PWM2_MODULE3_CHB_C19,
    PWM2_MODULE3_CHB_D3,
    PWM2_MODULE3_CHB_E20, // PWM2 子模块3 通道B  引脚可选范围
    PWM2_MODULE3_CHA_B0 = 2 * 40 + 5 * 7,
    PWM2_MODULE3_CHA_C18,
    PWM2_MODULE3_CHA_D2,
    PWM2_MODULE3_CHA_E19,
